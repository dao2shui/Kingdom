...
%PIELDUP duplicates pixels of an image in both direction.
% B=pixeldup(A,m,n) duplicates each pixel of A m times in the vertical
% direction and n time in the horizontal direction .Parameters M and N must
% be integers . If n is not included ,it defaults to m.
