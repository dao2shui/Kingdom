...
% Y = CV2TIFS(Y,F) decodes compressed sequence Y (a structure generated by
% TIFS2CV)and creates a multiframe ITFF file F.
% 
% See also TIFS2CV.

% Get the number of frames ,block size ,and reconstruction quanlity.
...
% For frames except the first ,get a motion conpensated prediction residual
% and add to the proper reference subimages.
for i = 2:fcnt
    if q == 0
