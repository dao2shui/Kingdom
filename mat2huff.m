...
%    y.code   The Huffman-encodeed values of x ,stored in a uint16
%             vector.The other fields of Y contain additional decoding
%             information,including:
%    y.min    The minimum value of x plus 32768
%    y.size   The size of x
%    y.hist   The histogram of x 
% 
% If x is logical ,uint8,uint16,uint32,int8,int16 ,or double,with integer
% values,it can be input directly to mat2huff.The minimum value of x must
% be representable as an int16.
% 
...
% before the call .For example ,use y=mat2huff(255*x) for 256 gray level
% encoding.
% 
% Note: The number of huffman code words is round(max(x(:))) -
% round(min(x(:))) + 1. You may need to scale input x to generate codes of
% reasonable length .The maximum row or column dimension of x is 65535.
% 
% See also huff2mat
