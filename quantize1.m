function y = quantize1(x,b,type)
%QUANTIZE1 Quantizes the element of a UINT8 matrix.
% y = quantize1(x,b,type) quantizes x to b bit .Truncation is used unless
...
% Perform standarf quantization unless IGS is specified
